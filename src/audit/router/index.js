...
import Layout from '@/audit/layout/index.vue'
...
export const constantRoutes = [
    ...
    children: [
      {
        path: '/flowmanedit1',
        name: '/flowmanedit1',
        component: () => import('@/audit/components/flow/index.vue'),
      ...
      },
      {
        path: 'flowstart',
        name: 'flowstart',
        component: () => import('@/audit/views/my-flow/flow-start.vue'),
        meta: { title: '发起申请', roles: ['admin'] },
      },
      {
        path: 'flowappvove',
        name: 'flowappvove',
        component: () => import('@/audit/views/my-flow/flow-approve.vue'),
        meta: { title: '待审批', roles: ['admin'] },
      },
      {
        path: 'flowmy',
        name: 'flowmy',
        component: () => import('@/audit/views/my-flow/flow-my.vue'),
        meta: { title: '我的申请', roles: ['admin'] },
      },
      {
        path: 'flowcc',
        name: 'flowcc',
        component: () => import('@/audit/views/my-flow/flow-cc.vue'),
        meta: { title: '我收到的', roles: ['admin'] },
      },
      {
        path: 'flowrecord',
        name: 'flowrecord',
        component: () => import('@/audit/views/my-flow/flow-record.vue'),
    ...
    children: [
      {
        path: '/flowmanindex',
        name: '/flowmanindex',
        component: () => import('@/audit/views/flow-manage/index.vue'),
        meta: { roles: ['admin'] },
      },
    ],
  },
    ...
    children: [
      {
        path: '/flowdataindex',
        name: '/flowdataindex',
        component: () => import('@/audit/views/flow-data/index.vue'),
        meta: { roles: ['admin'] },
      },
    ],
  },
  {
    path: '/flowmanedit',
    name: '/flowmanedit',
    component: () => import('@/audit/views/flow-manage/flow-edit.vue'),
    meta: { transition: 'fade-transform', roles: ['admin'] },
    hidden: true,
  },
]
