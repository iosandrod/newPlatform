          ...
          <template #columns>
            ...
            <a-table-column title="状态" :width="100">
              <template #cell="{ record }">
                ...
                <a-tag color="red" v-else-if="record.status == STATUS.REJECTED">
                  {{ STATUS_LIST[2].name }}
                </a-tag>
                <a-tag
                  color="orangered"
                  ...
                  <template v-if="record.status == STATUS.UNDERWAY">
                    ...
                    <a-tooltip content="转办" position="top" mini>
                      <a-button size="small" @click="onTransferOpen(record)">
                        <template #icon><IconSwap :size="18" /></template>
                      </a-button>
                    </a-tooltip>
                  </template>
                </div>
...
<script setup>
// import FlowDataApi from "@/audit/api/FlowDataApi";
let FlowDataApi = {}
...
import {
  STATUS,
  STATUS_LIST,
} from '@/audit/components/flow/common/FlowConstant'
