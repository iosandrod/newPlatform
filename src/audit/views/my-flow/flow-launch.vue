...
<script setup>
import FileApi, { FILE_DOWNLOAD_URL, FILE_UPLOAD_URL } from "@/audit/api/FileApi";


import FlowNodeAvatar from "@/audit/components/common/FlowNodeAvatar.vue";
import FlowNodeRoleAvatar from "@/audit/components/common/FlowNodeRoleAvatar.vue";
import RichText from "@/audit/components/common/RichText.vue";
import ArrayUtil from "@/audit/components/flow/common/ArrayUtil";
import CHINA_AREA from "@/audit/components/flow/common/ChinaArea";
import { NODE, NODE_COLOR, WIDGET } from "@/audit/components/flow/common/FlowConstant";
import { formFormulaAutoCalc } from "@/audit/components/flow/common/FlowFormula";
import ObjectUtil from "@/audit/components/flow/common/ObjectUtil";
import OrganChooseBox from "@/audit/components/flow/dialog/OrganChooseBox.vue";
import { useOrganStore } from "@/audit/stores";
import { getToken } from "@/audit/utils/auth";
