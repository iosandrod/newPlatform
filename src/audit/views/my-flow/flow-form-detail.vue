...
<script setup>
import { FILE_DOWNLOAD_URL } from "@/audit/api/FileApi";

import { WIDGET } from "@/audit/components/flow/common/FlowConstant";
import { formFormulaDetailCalc } from "@/audit/components/flow/common/FlowFormula";
import ObjectUtil from "@/audit/components/flow/common/ObjectUtil";
import { newline } from "@/audit/utils/format";
...
<style lang="scss">
@import "@/audit/styles/rich.text.less";
</style>
