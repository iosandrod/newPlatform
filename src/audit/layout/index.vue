  ...
  <section class="app-container">
    <header class="app-header-container">
      <div class="app-header-box">
        <div class="left-side">
          <a-space>
            <div class="logo"><img alt="Vue logo" class="logo" src="@/audit/assets/logo.png" height="24" /></div>
...
<script setup>
import { useAppStore, usePermissionStore, useUserStore } from "@/audit/stores";
import lessVars from "@/audit/styles/variables.module.scss";
import SwitchUser from "@/audit/views/user/SwitchUser.vue";
