        ...
        <template #content>
          <div class="add-node-popover-wrap">
            <div
              ...
              @click="onNodeAddClicked(NODE.APPROVE)"
            >
              <div class="node-icon">
                <span
                  class="iconfont-approval-admin"
                  v-html="icons[NODE.APPROVE].icon"
                ></span>
              </div>
              <div class="node-text">审批人</div>
            </div>
            <div
              class="add-node-popover-item copyer"
              @click="onNodeAddClicked(NODE.COPY)"
            >
              <div class="node-icon">
                <span
                  class="iconfont-approval-admin"
                  v-html="icons[NODE.COPY].icon"
                ></span>
              </div>
              <div class="node-text">抄送人</div>
            </div>
            <div
              class="add-node-popover-item transactor"
              @click="onNodeAddClicked(NODE.TRANSACT)"
            >
              <div class="node-icon">
                <span
                  class="iconfont-approval-admin"
                  v-html="icons[NODE.TRANSACT].icon"
                ></span>
              </div>
            ...
            <div
              ...
              @click="onNodeAddClicked(NODE.EXCLUSIVE_GATEWANY)"
            >
              <div class="node-icon">
                <span
                  class="iconfont-approval-admin"
                  v-html="icons[NODE.EXCLUSIVE_GATEWANY].icon"
                ></span>
              </div>
...
// const comp = resolveComponent('erForm')
// debugger //
