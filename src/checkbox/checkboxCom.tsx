...
import { getFuncText } from 'vxe-pc-ui/packages/ui/src/utils'
// import { getConfig, createEvent, useSize, getIcon } from '../../ui'
import { getConfig, createEvent, useSize, getIcon } from 'vxe-pc-ui/packages/ui'
...
export default defineComponent({
  ...
  props: {
    ...
    modelValue: [String, Number, Boolean] as PropType<
      VxeCheckboxPropTypes.ModelValue
    >,
    label: {
    ...
    checkedValue: {
      type: [String, Number, Boolean] as PropType<
        VxeCheckboxPropTypes.CheckedValue
      >,
      default: 1,
    },
    uncheckedValue: {
      type: [String, Number, Boolean] as PropType<
        VxeCheckboxPropTypes.UncheckedValue
      >,
      default: 0,
    },
  ...
  setup(props, context) {
    ...
    const $xeCheckboxGroup = inject<
      (VxeCheckboxGroupConstructor & VxeCheckboxGroupPrivateMethods) | null
    >('$xeCheckboxGroup', null)
        ...
        [
          ...
          h('span', {
            class: [
              'vxe-checkbox--icon',
              indeterminate
                ? getIcon().CHECKBOX_INDETERMINATE
                : isChecked
                ? getIcon().CHECKBOX_CHECKED
                : getIcon().CHECKBOX_UNCHECKED,
            ],
          }),
          h(
            'span',
